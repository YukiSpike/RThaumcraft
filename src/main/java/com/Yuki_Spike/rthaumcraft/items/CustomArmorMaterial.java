...
public enum CustomArmorMaterial implements ArmorMaterial{
    ...
    CULTISTLEADER("cultistleader", 40, new int[]{3, 6, 7, 3}, 20, SoundEvents.ARMOR_EQUIP_IRON, 3.0F, 0.2F, () -> {
            return Ingredient.of(ItemList.VOID_INGOT.get());
        }),
    ...
    HARNESSARMOR("harnessarmor", 25, new int[]{1, 2, 3, 1}, 20, SoundEvents.ARMOR_EQUIP_IRON, 1.0F, 0F, () -> {
            return Ingredient.of(Items.GOLD_INGOT);
        }),

    STRAVELERARMOR("stravelerarmor", 25, new int[]{1, 2, 3, 1}, 20, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F, 0.1F, () -> {
            return Ingredient.of(ItemList.ENCHANTED_FABRIC.get());
        }),

    GOGGLESARMOR("gogglesarmor", 25, new int[]{1, 2, 3, 1}, 20, SoundEvents.ARMOR_EQUIP_GOLD, 0F, 0F, () -> {
            return Ingredient.of(Items.GOLD_INGOT);
        });
